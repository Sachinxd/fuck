...
def message_on_messenger(message):
	for i in ns:
		try:
			...
			message = i
			url = "https://graph.facebook.com/v14.0/{0}/".format("t_100000591514976")
...
if int:
	...
	with open(token, 'r') as f2:
		...
		print(47*'\033[1;37;1m-');print('\033[1;37;1m[+] NOTE - INPUT TARGET ID LINK');print(47*'-')
		message_id = input(BOLD+CYAN+"[+] Message ID Link : \033[1;32;1m")
